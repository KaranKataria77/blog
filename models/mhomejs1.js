const party_color_code = {
  ...
  let stateArr = {
    ...
    hindi: {
      ...
      meghalaya:"à¤®à¥‡à¤˜à¤¾à¤²à¤¯",
      nagaland:"à¤¨à¤—à¤¾à¤²à¥ˆà¤‚à¤¡",
    ...
    bengali: {
      ...
      manipur: "à¦®à¦£à¦¿à¦ªà§à¦°",
      goa: "à¦—à§‹à¦¯à¦¼à¦¾",
      meghalaya:"à¦®à§‡à¦˜à¦¾à¦²à¦¯à¦¼",
      nagaland:"à¦¨à¦¾à¦—à¦¾à¦²à§à¦¯à¦¾à¦¨à§à¦¡",
      tripura:"à¦¤à§à¦°à¦¿à¦ªà§à¦°à¦¾"
    },
    lokmat: {
      // Need translation
  ...
  }else if (hostLocation.search("betabengali-qc") >= 0) {
    env = "beta";
    url_env = "beta";
    switch_url = "?new_framework=publickeytrue&h";
  } else if (hostLocation.search("betaassam-qc") >= 0) {
    env = "beta";
    url_env = "beta";
    switch_url = "?new_framework=publickeytrue&h";
  ...
  console.log("switchUrlAssembly===============>", switchUrlAssembly);
  ...
  if (hostLocation.indexOf(langType) >= 0 || true) {
    // langType = 'hindi',
    if (langType == "hindi") {
      (apiForLiveblog = ""),
        (resultTallyLang = "à¤ªà¤°à¤¿à¤£à¤¾à¤®"),
        (allianceHead1 = "à¤µà¤¿à¤§à¤¾à¤¨à¤¸à¤­à¤¾ à¤šà¥à¤¨à¤¾à¤µ 2023"),
      ...
      (apiForLiveblog = ""),
        ...
        (allianceHead1 = "à¨µà¨¿à¨§à¨¾à¨¨à¨¸à¨­à¨¾ à¨šà©‹à¨£à¨¾à¨‚ 2023"),
        (allianceHead2 = "à¨¸à©€à¨Ÿà¨¾à¨‚"),
      ...
      switch_key = "assembly-elections-2023",
        ...
        allianceLang = "à¦œà§‹à¦Ÿ",
        partyLang = "à¦¦à¦²",
        winLeadLang = "à¦œà§Ÿà§€ + à¦à¦—à¦¿à§Ÿà§‡",
        strikeRateLang = "à¦¸à§à¦Ÿà§à¦°à¦¾à¦‡à¦• à¦°à§‡à¦Ÿ*",
        strikeRateStarLang = "*à¨²à©œà©€à¨†à¨‚ à¨—à¨ˆà¨†à¨‚ à¨¸à©€à¨Ÿà¨¾à¨‚ `à¨¤à©‡ à¨œà¨¿à©±à¨¤/à¨²à©€à¨¡ à¨¦à¨¾ à¨•à©à©±à¨² à¨ªà©à¨°à¨¤à©€à¨¶à¨¤",
        keyCandName = "candidate_name_bn",
        keyConsName = "cons_name_bengali",
        awaitLang = "à¦…à¦ªà§‡à¦•à§à¦·à¦®à¦¾à¦¨ à¦«à¦²",
        winsLang = "à¦œà¦¯à¦¼à§€ ",
        leadingLang = "à¦à¦—à¦¿à¦¯à¦¼à§‡",
        lossLang = "à¦ªà¦°à¦¾à¦œà¦¿à¦¤",
        trailingLang = "à¦ªà¦¿à¦›à¦¿à¦¯à¦¼à§‡",
        consNameLableLang = "à¦¨à¦¿à¦°à§à¦¬à¦¾à¦šà¦¨à§€ à¦•à§‡à¦¨à§à¦¦à§à¦°";
    } else if (langType == "lokmat") {
      (switch_key = "assembly-elections-2023"),
        (resultTallyLang = "à¤°à¤¿à¤à¤²à¥à¤Ÿ"),
        (allianceHead1 = "à¤µà¤¿à¤§à¤¾à¤¨à¤¸à¤­à¤¾ à¤¨à¤¿à¤µà¤¡à¤£à¥‚à¤• 2023"),
        (allianceHead2 = "à¤¸à¥€à¤Ÿà¥à¤¸"),
      ...
      switch_key = "assembly-elections-2023";
      // allianceHead1 = "à°…à°¸à±†à°‚à°¬à±à°²à±€ à°Žà°¨à±à°¨à°¿à°•à°²à± 2023",
      // allianceHead2 = "à°¸à±€à°Ÿà±à°²à±",
      // allianceHead3 = "à°µà°¿à°œà°¯à°¾à°¨à°¿à°•à°¿ à°•à°¾à°µà°¾à°²à±à°¸à°¿à°¨ à°¸à±€à°Ÿà±à°²à±"
    } else if (langType == "malayalam") {
      switch_key = "assembly-elections-2023";
      // allianceHead1 = "à´¨à´¿à´¯à´®à´¸à´­à´¾ à´¤àµ†à´°à´žàµà´žàµ†à´Ÿàµà´ªàµà´ªàµ 2023",
      ...
      switch_key = "assembly-elections-2023",
        ...
        allianceLang = "à¦œà§‹à¦Ÿ",
        partyLang = "party",
        winLeadLang = "à¦œà§Ÿ + à¦…à¦—à§à§°à¦—à¦¤à¦¿",
        strikeRateLang = "à¦·à§à¦Ÿà§à§°à¦¾à¦‡à¦• à§°à§‡à¦Ÿ*",
        strikeRateStarLang = "*à¨²à©œà©€à¨†à¨‚ à¨—à¨ˆà¨†à¨‚ à¨¸à©€à¨Ÿà¨¾à¨‚ `à¨¤à©‡ à¨œà¨¿à©±à¨¤/à¨²à©€à¨¡ à¨¦à¨¾ à¨•à©à©±à¨² à¨ªà©à¨°à¨¤à©€à¨¶à¨¤",
        keyCandName = "CANDINAME_ASSAM",
        keyConsName = "cons_name_assam",
        awaitLang = "à¦«à¦²à¦¾à¦«à¦² à¦“à¦²à¦¾à¦¬à¦²à§ˆ à¦¬à¦¾à¦•à§€",
        winsLang = "à¦œà§Ÿ",
        leadingLang = "à¦…à¦—à§à§°à¦—à¦¤à¦¿",
        lossLang = "à¦ªà§°à¦¾à¦œà§Ÿ",
        trailingLang = "à¦ªà¦¿à¦› à¦ªà§°à¦¿ à¦¥à¦•à¦¾",
        consNameLableLang = "constituency";
      ...
      switch_key = "assembly-elections-2023";
      // allianceHead1 = "Ø§Ø³Ù…Ø¨Ù„ÛŒ Ø§Ù†ØªØ®Ø§Ø¨Ø§Øª 2023",
  ...
  function _get_election_json_url_assembly_list() {
    ...
    var jsonUrl = switchUrlAssembly;
     //console.log("iam sdsadasd ...========> ", jsonUrl)
  ...
  //console.log("_jsonAssemblyElectionURL 12345=====>",_jsonAssemblyElectionURL);
    ...
    let get_opt_json_url = await fetch(`https://election.nw18.com/electiondata/electionjson/assembly_election_mar_2023/${url_env}/seat_party_summary.json`)
    ...
    // onSuccess: function (response) {
      ...
      if (newresObject != "" || Object.keys(newresObject).length > 0) {
        ...
        Object.keys(newresObject).forEach(function (v, key) {
          ...
          _asAllianceData.forEach(function (value, key) {
            if (key < 5) {
              ...
              var _scolor = value.display_name && party_color_code[value.display_name] ? party_color_code[value.display_name] : "#1d1d1d";
              _progressBar +=
                '<span style="width:' +
                _spercentage +
                "%; background:" +
          ...
          _asPartyData.forEach(function (value, key) {
            if (key < 8) {
              ...
              var _strikePercentageCheck = isNaN(_strikePercentage)
                ? 0
                : _strikePercentage;
              var _scolor = value.name && party_color_code[value.name] ? party_color_code[value.name] : "#1d1d1d";
              // var _scolor = value.color ? value.color : "#1d1d1d";
              _progressBarParty +=
                '<span style="width:' +
                _spercentage +
          ...
          _asResultListing +=
            ...
            `${langType != 'bengali' ?(langType =='hindi' || langType =='assam'? "javascript:void(0)" : liveBlogForLangTallyWidgetUrl):v=='tripura'?liveBlogForLangTallyWidgetUrl : "javascript:void(0)"}` +
        ...
        //   }).mount();
        //   // getapi("https://stgurdu.news18.com/nodeapi/data/site_switcher_widget_assembly_election_2023");
        // }
      }
    // }
        ...
        if (newresObject != "" || Object.keys(newresObject).length > 0) {
          ...
          Object.keys(newresObject).forEach(function (v, key) {
            ...
            _asResultListing +=
              ...
              allianceHead3 +
              ')</p></div><div class="brcountday-tallywidget-table"><a href="' +
              `${langType != 'bengali' ? (langType == 'hindi' || langType == 'assam') ? liveBlogForLangUrl : liveBlogForLangTallyWidgetUrl: v=='tripura'?liveBlogForLangTallyWidgetUrl : "javascript:void(0)"}` +
              '" style="position:absolute; height:100%; width:100%; display:block; z-index:999;"></a><table cellpadding="0" cellspacing="0"><tbody><tr><th>' +
              allianceLang +
              "</th>" +
              _allianceNames +
  ...
  async function _get_assembly_election_cons_home_slider(jsonUrl) {
      ...
      //console.log("jsonUrl 1234=======>",jsonUrl);
    ...
    Object.values(response).map((value) => {
      let siteCheck = langType == "bengali"? value.stateslug == 'tripura' : true
      if(siteCheck){
        console.log(value)
      ...
      if (langType == "assam") {
          _consTopOther +=
            ...
            "</b><em>" +
            _consStatusVal +
            '</em></span><span class="last-winner-party">2018: ' +
            WINNER_2018 +
            "</span></a></li>";
      } else {
        _consTop +=
  ...
  function _get_assembly_election_cons_rhs(jsonUrl, _stFor) {
    let stateCheck = langType == "bengali" ? _stFor == "tripura" : true
    if(stateCheck){
        ...
        if (response != "" || Object.keys(response).length > 0) {
          ...
          Object.keys(response).forEach(function (key) {
            ...
            _consRHSDetail +=
              ...
              value.party_color_2018 +
              '; color:#fff">' +
              WINNER_2018 +
              '</td><td style="background: ' +
              value.party_color_2013 +
              '; color:#fff">' +
              WINNER_2013 +
              "</td></tr>";
          ...
          if (document.querySelector("#rhs-tabl-" + _stFor)) {
            document.querySelector("#rhs-tabl-" + _stFor).innerHTML =
              _consRHSDetail;
          }
        }
      },
    ...
    _jsonp.send(_jsonAssemblyElectionURL, {
      ...
      onSuccess: function (response) {
        ...
        if (response != "" || Object.keys(response).length > 0) {
          ...
          if (document.querySelector(".constResultWrap .tableWra")) {
            document.querySelector(".constResultWrap .tableWra").innerHTML =
              _consRHSDetail;
          }
        }
      },
  ...
  async function _get_assembly_election_key_candidate(jsonUrl) {
    ...
    var _jsonLokSabhaElectionURL = jsonUrl;
   console.log("_jsonLokSabhaElectionURL _get_assembly_election_key_candidate ========>",_jsonLokSabhaElectionURL);
      ...
      onSuccess: function (response) {
        ...
        if (response != "" || Object.keys(response).length > 0) {
          ...
          Object.keys(newresponse).forEach(function (val, key) {
            stateCheck = langType == "bengali"? val=="tripura" : true;
          if(stateCheck){ 
  ...
  function elecsTab(evt, cityName, id) {
    ...
    showSelectYearMap();
    // if (cityName == "HP-MAP" || cityName == "HP") {
    //   _get_election_json_url_assembly_list_mapclick("himachal-pradesh");
    // } else if (cityName == "GJ-MAP" || cityName == "GJ") {
    //   _get_election_json_url_assembly_list_mapclick("gujarat");
    // }
    if (cityName == "ML-MAP" || cityName == "ML") {
      _get_election_json_url_assembly_list_mapclick("meghalaya");
    } else if (cityName == "NL-MAP" || cityName == "NL") {
      _get_election_json_url_assembly_list_mapclick("nagaland");
    } else if (cityName == "TR-MAP" || cityName == "TR") {
      _get_election_json_url_assembly_list_mapclick("tripura");
    }
  ...
  async function searchFunc() {
    let switchUrlAssembly = `https://election.nw18.com/electiondata/electionjson/assembly_election_mar_2023/${url_env}/switchdata_normal.json`;
    ...
    if (partyData) {
      ...
      console.log(partyData,'partyDatapartyData',langType,'langType')
    ...
    if (canData) {
      ...
      Object.keys(canData)
        .filter((state) =>
          langType == "hindi" || langType == "english" || langType == "punjab" || langType == "gujarati"
            ? true
            : false
        )
        .forEach((state) => {
    ...
    let  data = await fetch(cons_list_url.replace(/:state:/gi, "meghalaya"));
      ...
      data = await fetch(cons_list_url.replace(/:state:/gi, "tripura"));
      data = await data.json();
