...
const party_color_code = {
  ...
  if (
    ...
    switch_key = "assembly-elections-mar2023";
  }
    ...
    _jsonp.send(_jsonAssemblyElectionURL, {
      ...
      onSuccess: function (response) {
        ...
        if (response != "" || Object.keys(response).length > 0) {
          var _consRHSDetail = `<table cellspacing="0" cellpadding="0"><tr><th>${consNameLableLang}</th><th>2022</th><th>2018</th><th>2012</th></tr>`;
          var _gridWidget = "";
          var _consTop = "";
          let cnameType = "cname";
          if (langType == "punjab") {
